...
# 분할 익절 전략 설정
# 상승 추세일 때 익절 레벨 및 비율 [(익절%, 익절비율), ...]
TAKE_PROFIT_LEVELS_UPTREND = [
    (3.0, 0.3),   # 3%에서 30% 익절
    (5.0, 0.4),   # 5%에서 40% 익절
    (7.0, 0.2),   # 7%에서 20% 익절
    (10.0, 0.1)   # 10%에서 10% 익절 (나머지)
]

# 하락 추세일 때 익절 레벨 및 비율 (빠른 익절 유도)
TAKE_PROFIT_LEVELS_DOWNTREND = [
    (1.5, 0.4),   # 1.5%에서 40% 익절
    (2.5, 0.3),   # 2.5%에서 30% 익절
    (4.0, 0.2),   # 4%에서 20% 익절
    (6.0, 0.1)    # 6%에서 10% 익절 (나머지)
]

# 횡보 추세일 때 익절 레벨 및 비율
TAKE_PROFIT_LEVELS_SIDEWAYS = [
    (2.0, 0.3),   # 2%에서 30% 익절
    (4.0, 0.4),   # 4%에서 40% 익절
    (6.0, 0.2),   # 6%에서 20% 익절
    (8.0, 0.1)    # 8%에서 10% 익절 (나머지)
]
